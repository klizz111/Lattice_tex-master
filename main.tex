...
在此背景下，美国国家标准与技术研究院（NIST）于2016年启动了全球性的后量子密码标准化进程。经过多轮严格的评估与筛选，NIST于2024年8月正式发布了首批后量子密码标准，即联邦信息处理标准（FIPS）203-111 (Module-LWE-based Key Encapsulation Mechanism - ML-KEM)、FIPS 204-121 (Module-LWE-based Digital Signature - ML-DSA) 和 FIPS 205 (Stateless Hash-Based Digital Signature - SLH-DSA)。其中，FIPS 203 (Crystals-Kyber) 与 FIPS 204 (Crystals-Dilithium) 标准均奠基于模格学习带错误问题 (Module Learning With Errors, MLWE)，分别用于密钥封装和数字签名。
